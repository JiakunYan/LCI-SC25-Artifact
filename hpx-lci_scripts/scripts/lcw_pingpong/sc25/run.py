...
rt_configs = [
    ...
    {"rt_name": "mpi-ucx", "lcw:backend": "mpi", "spack_env": "lcw-mpi-ucx", "when": lambda config: platformConfig.name == "expanse"},
    {"rt_name": "cray-mpich", "lcw:backend": "mpi", "spack_env": "lcw-cray-mpich", "when": lambda config: platformConfig.name == "delta"},
]
